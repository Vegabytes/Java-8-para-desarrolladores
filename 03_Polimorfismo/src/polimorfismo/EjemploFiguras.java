...
public class EjemploFiguras {
	...
	public static void main(String[] args) {
		...
		//Tanto la figura como el tamaño de la misma son aleatorioas
		
		for (int i = 0; i < 10; i++) {
			listaFiguras.add(tirarMoneda() ? new Rectangulo(aleatorio(50), aleatorio(50)) : new Cuadrado(aleatorio(50)));
		}
